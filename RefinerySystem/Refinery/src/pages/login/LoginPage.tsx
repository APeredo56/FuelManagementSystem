...
const LoginPage = () => {
    ...
    const fetchUserInfo = () => {
        AuthService.me().then(response => {
            if (response.role !== ROLE_IDS.REFINERY_MANAGER && response.role !== ROLE_IDS.DRIVER) {
            ...
            response.role === ROLE_IDS.REFINERY_MANAGER ? navigate(Routes.HOME.ADMIN) : navigate(Routes.HOME.DRIVER);
        });
    }
